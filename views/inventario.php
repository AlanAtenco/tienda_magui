                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-floating mb-3">
                            ...
                            <label style="color: #FF1493;" for="producto"><i class="fa-solid fa-envelope me-2"></i>Producto</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="precio" name="precio" type="text" placeholder="Precio">
                            <label style="color: #FF1493;" for="precio"><i class="fa-solid fa-envelope me-2"></i>Precio</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="unidades" name="unidades" type="text" placeholder="Unidades">
                            <label style="color: #FF1493;" for="unidades"><i class="fa-solid fa-envelope me-2"></i>Unidades</label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label style="color: #FF1493;" for="usuario"><i class="fa-solid fa-envelope me-2"></i>Producto</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="edit_precio" name="edit_precio" type="text" placeholder="Precio">
                            <label style="color: #FF1493;" for="usuario"><i class="fa-solid fa-envelope me-2"></i>Precio</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="edit_unidades" name="edit_unidades" type="text" placeholder="Unidades">
                            <label style="color: #FF1493;" for="usuario"><i class="fa-solid fa-envelope me-2"></i>Unidades</label>
                        </div>
                    </div>
                </div>
            </div>
